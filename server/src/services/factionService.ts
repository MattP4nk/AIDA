...
export class FactionService extends EventEmitter {
  ...
  public async joinFaction(
    ...
    return await safeExecute({
      ...
      context: "Join faction",
      logger: this.logger,
      fallback: { success: false, message: "Failed to join faction due to an internal error." },
  ...
  public async leaveFaction(
    ...
    return await safeExecute({
      ...
      context: "Leave faction",
      logger: this.logger,
      fallback: { success: false, message: "Failed to leave faction due to an internal error." },
    })() as { success: boolean; message: string };
  }
  ...
  public async initializeStandings(userId: string): Promise<void> {
    await safeExecute({
      ...
      context: "Initialize faction standings",
      logger: this.logger,
    })();
  }
